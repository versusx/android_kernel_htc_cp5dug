...
enum flashlight_mode_flags {
	...
	FL_MODE_CAM_FLASH_LEVEL1,//HTC_CAM_START chuck
	FL_MODE_CAM_FLASH_LEVEL2,
	FL_MODE_CAM_FLASH_LEVEL3,
	FL_MODE_CAM_FLASH_LEVEL4,
	FL_MODE_CAM_FLASH_LEVEL5,
	FL_MODE_CAM_FLASH_LEVEL6,
	FL_MODE_CAM_FLASH_LEVEL7,//HTC_CAM_END
};
