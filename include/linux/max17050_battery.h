...
struct poweralg_config_type
{
	...
	BOOL debug_fake_percentage;
	INT32 full_level;                  
	BOOL debug_force_fast_charging;
};
...
#define MAX17050_FULL_CAPACITY_DEFAULT	2100
#else
#define MAX17050_FULL_CAPACITY_DEFAULT	1800
#endif
...
extern void max17050_batt_softPOR(void);
extern int max17050_read_current(void);
...
extern ssize_t htc_battery_show_htc_extension_attr(struct device_attribute *attr, char *buf);
