...
#define MAX17050_STATUS_PORF  (1 << 6)	/* write to 0 as power-up sequence ready*/
#define MAX17050_STATUS_SMOD  (1 << 5)	/* write to 0 to disable MAX17050 sleep mode*/
#define MAX17050_STATUS_NBEN  (1 << 4)	/* write to 0 to disable blanking of negative currents*/
...
struct protect_flags_type{
		...
		BOOL is_charging_reverse_protect; /* trigger by CHG_INT */
...
/* Battery maxim fuel gauge debug log */
