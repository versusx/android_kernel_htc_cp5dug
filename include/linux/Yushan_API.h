...
/*#ifndef DEBUGGING
   ...
   #define DEBUGLOG(str)  fprintf(HtmlFileLog, "%s%s", str, "<hr>\n");
   #else
   #define DEBUGLOG(str)	// Nothing
 #endif*/
...
// Status Functions
bool_t Yushan_Read_AF_Statistics(uint32_t  *sYushanAFStats, uint8_t bNumOfActiveRoi);
