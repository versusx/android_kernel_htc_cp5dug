...
#define UMCTL_MSTR       UMCTL2_REG_(0x0000) 
#define UMCTL_STAT       UMCTL2_REG_(0x0004) 
#define UMCTL_MRCTRL0    UMCTL2_REG_(0x0010) 
#define UMCTL_MRCTRL1    UMCTL2_REG_(0x0014) 
#define UMCTL_MRSTAT     UMCTL2_REG_(0x0018) 

#define UMCTL_DERATEEN   UMCTL2_REG_(0x0020)
#define UMCTL_DERATEINT  UMCTL2_REG_(0x0024)
#define UMCTL_PWRCTL     UMCTL2_REG_(0x0030)
#define UMCTL_PWRTMG     UMCTL2_REG_(0x0034)

#define UMCTL_RFSHCTL0   UMCTL2_REG_(0x0050)
#define UMCTL_RFSHCTL1   UMCTL2_REG_(0x0054)
#define UMCTL_RFSHCTL2   UMCTL2_REG_(0x0058)
#define UMCTL_RFSHCTL3   UMCTL2_REG_(0x0060)
#define UMCTL_RFSHTMG    UMCTL2_REG_(0x0064)
#define UMCTL_ECCCFG0    UMCTL2_REG_(0x0070)
#define UMCTL_ECCCFG1    UMCTL2_REG_(0x0074)
#define UMCTL_ECCSTAT    UMCTL2_REG_(0x0078)
#define UMCTL_ECCCLR     UMCTL2_REG_(0x007C)
#define UMCTL_ECCERRCNT  UMCTL2_REG_(0x0080)

#define UMCTL_ECCADDR0   UMCTL2_REG_(0x0084)
#define UMCTL_ECCADDR1   UMCTL2_REG_(0x0088)
#define UMCTL_ECCSYN0    UMCTL2_REG_(0x008C)
...
#define UMCTL_ECCUADDR0      UMCTL2_REG_(0x00A4)
#define UMCTL_ECCUADDR1      UMCTL2_REG_(0x00A8)
#define UMCTL_ECCUSYN0       UMCTL2_REG_(0x00AC)
#define UMCTL_ECCUSYN1       UMCTL2_REG_(0x00B0)
#define UMCTL_ECCUSYN2       UMCTL2_REG_(0x00B4)
#define UMCTL_ECCPOISONADDR0 UMCTL2_REG_(0x00B8)
#define UMCTL_ECCPOISONADDR1 UMCTL2_REG_(0x00BC)


#define UMCTL_PARCTL     UMCTL2_REG_(0x00C0)
#define UMCTL_PARSTAT    UMCTL2_REG_(0x00C4)

#define UMCTL_INIT0      UMCTL2_REG_(0x00D0)
...
#define UMCTL_DIMMCTL    UMCTL2_REG_(0x00F0)
#define UMCTL_RANKCTL    UMCTL2_REG_(0x00F4)

#define UMCTL_DRAMTMG0   UMCTL2_REG_(0x0100)
...
#define UMCTL_ZQCTL0     UMCTL2_REG_(0x0180)
#define UMCTL_ZQCTL1     UMCTL2_REG_(0x0184)
#define UMCTL_ZQCTL2     UMCTL2_REG_(0x0188)
#define UMCTL_ZQSTAT     UMCTL2_REG_(0x018C)


#define UMCTL_DFITMG0    UMCTL2_REG_(0x0190)
#define UMCTL_DFITMG1    UMCTL2_REG_(0x0194)

#define UMCTL_DFILPCFG0  UMCTL2_REG_(0x0198)
#define UMCTL_DFIUPD0    UMCTL2_REG_(0x01A0)
...
#define UMCTL_TRAINCTL0  UMCTL2_REG_(0x01D0)
...
#define UMCTL_ADDRMAP0   UMCTL2_REG_(0x0200)
...
#define UMCTL_ODTCFG     UMCTL2_REG_(0x0240)
#define UMCTL_ODTMAP     UMCTL2_REG_(0x0244)

#define UMCTL_SCHED      UMCTL2_REG_(0x0250)
#define UMCTL_PERFHPR0   UMCTL2_REG_(0x0258)
#define UMCTL_PERFHPR1   UMCTL2_REG_(0x025C)
#define UMCTL_PERFLPR0   UMCTL2_REG_(0x0260)
#define UMCTL_PERFLPR1   UMCTL2_REG_(0x0264)

#define UMCTL_PERFWR0    UMCTL2_REG_(0x0268)
#define UMCTL_PERFWR1    UMCTL2_REG_(0x026C)
#define UMCTL_DBG0       UMCTL2_REG_(0x0300)
#define UMCTL_DBG1       UMCTL2_REG_(0x0304)
#define UMCTL_DBGCAM     UMCTL2_REG_(0x0308)


#define UMCTL_PCCFG      UMCTL2_REG_(0x0400)

#define UMCTL_PCFGR_0    UMCTL2_REG_(0x0404+(0x00)*0xB0)
...
#define UMCTL_PCFGW_0    UMCTL2_REG_(0x0408+(0x00)*0xB0)
...
#define UMCTL_PORT_EN_0    0xFFFF0000
#define UMCTL_PORT_EN_1    0xFFFF0000
#define UMCTL_PORT_EN_2    0xFFFF0000
#define UMCTL_PORT_EN_3    0xFFFF0000
#define UMCTL_PORT_EN_4    0xFFFF0000
#define UMCTL_PORT_EN_5    0xFFFF0000
#define UMCTL_PORT_EN_6    0xFFFF0000
#define UMCTL_PORT_EN_7    0xFFFF0000
#define UMCTL_PORT_EN_8    0xFFFF0000
#define UMCTL_PORT_EN_9    0xFFFF0000




#define PUBL_RIDR           (PUBL_REG_BASE+0x00*4) 
#define PUBL_PIR            (PUBL_REG_BASE+0x01*4) 
#define PUBL_PGCR           (PUBL_REG_BASE+0x02*4) 
#define PUBL_PGSR           (PUBL_REG_BASE+0x03*4) 
#define PUBL_DLLGCR         (PUBL_REG_BASE+0x04*4) 
#define PUBL_ACDLLCR        (PUBL_REG_BASE+0x05*4) 
#define PUBL_PTR0           (PUBL_REG_BASE+0x06*4) 
#define PUBL_PTR1           (PUBL_REG_BASE+0x07*4) 
#define PUBL_PTR2           (PUBL_REG_BASE+0x08*4) 
#define PUBL_ACIOCR         (PUBL_REG_BASE+0x09*4) 
#define PUBL_DXCCR          (PUBL_REG_BASE+0x0A*4) 
#define PUBL_DSGCR          (PUBL_REG_BASE+0x0B*4) 
#define PUBL_DCR            (PUBL_REG_BASE+0x0C*4) 
#define PUBL_DTPR0          (PUBL_REG_BASE+0x0D*4) 
#define PUBL_DTPR1          (PUBL_REG_BASE+0x0E*4) 
#define PUBL_DTPR2          (PUBL_REG_BASE+0x0F*4) 
#define PUBL_MR0            (PUBL_REG_BASE+0x10*4) 
#define PUBL_MR1            (PUBL_REG_BASE+0x11*4) 
#define PUBL_MR2            (PUBL_REG_BASE+0x12*4) 
#define PUBL_MR3            (PUBL_REG_BASE+0x13*4) 
#define PUBL_ODTCR          (PUBL_REG_BASE+0x14*4) 
#define PUBL_DTAR           (PUBL_REG_BASE+0x15*4) 
#define PUBL_DTDR0          (PUBL_REG_BASE+0x16*4) 
#define PUBL_DTDR1          (PUBL_REG_BASE+0x17*4) 
#define PUBL_DCUAR          (PUBL_REG_BASE+0X30*4) 
#define PUBL_DCUDR          (PUBL_REG_BASE+0x31*4) 
#define PUBL_DCURR          (PUBL_REG_BASE+0x32*4) 
#define PUBL_DCULR          (PUBL_REG_BASE+0x33*4) 
#define PUBL_DCUGCR         (PUBL_REG_BASE+0x34*4) 
#define PUBL_DCUTPR         (PUBL_REG_BASE+0x35*4) 
#define PUBL_DCUSR0         (PUBL_REG_BASE+0x36*4) 
#define PUBL_DCUSR1         (PUBL_REG_BASE+0x37*4) 
#define PUBL_BISTRR         (PUBL_REG_BASE+0x40*4) 
#define PUBL_BISTMSKR0      (PUBL_REG_BASE+0x41*4) 
#define PUBL_BISTMSKR1      (PUBL_REG_BASE+0x42*4) 
#define PUBL_BISTWCR        (PUBL_REG_BASE+0x43*4) 
#define PUBL_BISTLSR        (PUBL_REG_BASE+0x44*4) 
#define PUBL_BISTAR0        (PUBL_REG_BASE+0x45*4) 
#define PUBL_BISTAR1        (PUBL_REG_BASE+0x46*4) 
#define PUBL_BISTAR2        (PUBL_REG_BASE+0x47*4) 
#define PUBL_BISTUDPR       (PUBL_REG_BASE+0x48*4) 
#define PUBL_BISTGSR        (PUBL_REG_BASE+0x49*4) 
#define PUBL_BISTWER        (PUBL_REG_BASE+0x4A*4) 
#define PUBL_BISTBER0       (PUBL_REG_BASE+0x4B*4) 
#define PUBL_BISTBER1       (PUBL_REG_BASE+0x4C*4) 
#define PUBL_BISTBER2       (PUBL_REG_BASE+0x4D*4) 
#define PUBL_BISTWCSR       (PUBL_REG_BASE+0x4E*4) 
#define PUBL_BISTFWR0       (PUBL_REG_BASE+0x4F*4) 
#define PUBL_BISTFWR1       (PUBL_REG_BASE+0x50*4) 
#define PUBL_ZQ0CR0         (PUBL_REG_BASE+0x60*4) 
#define PUBL_ZQ0CR1         (PUBL_REG_BASE+0x61*4) 
#define PUBL_ZQ0SR0         (PUBL_REG_BASE+0x62*4) 
#define PUBL_ZQ0SR1         (PUBL_REG_BASE+0x63*4) 
#define PUBL_ZQ1CR0         (PUBL_REG_BASE+0x64*4) 
#define PUBL_ZQ1CR1         (PUBL_REG_BASE+0x65*4) 
#define PUBL_ZQ1SR0         (PUBL_REG_BASE+0x66*4) 
#define PUBL_ZQ1SR1         (PUBL_REG_BASE+0x67*4) 
#define PUBL_ZQ2CR0         (PUBL_REG_BASE+0x68*4) 
#define PUBL_ZQ2CR1         (PUBL_REG_BASE+0x69*4) 
#define PUBL_ZQ2SR0         (PUBL_REG_BASE+0x6A*4) 
#define PUBL_ZQ2SR1         (PUBL_REG_BASE+0x6B*4) 
#define PUBL_ZQ3CR0         (PUBL_REG_BASE+0x6C*4) 
#define PUBL_ZQ3CR1         (PUBL_REG_BASE+0x6D*4) 
#define PUBL_ZQ3SR0         (PUBL_REG_BASE+0x6E*4) 
#define PUBL_ZQ3SR1         (PUBL_REG_BASE+0x6F*4) 
#define PUBL_DX0GCR         (PUBL_REG_BASE+0x70*4) 
#define PUBL_DX0GSR0        (PUBL_REG_BASE+0x71*4) 
#define PUBL_DX0GSR1        (PUBL_REG_BASE+0x72*4) 
#define PUBL_DX0DLLCR       (PUBL_REG_BASE+0x73*4) 
#define PUBL_DX0DQTR        (PUBL_REG_BASE+0x74*4) 
#define PUBL_DX0DQSTR       (PUBL_REG_BASE+0x75*4) 
#define PUBL_DX1GCR         (PUBL_REG_BASE+0x80*4) 
#define PUBL_DX1GSR0        (PUBL_REG_BASE+0x81*4) 
#define PUBL_DX1GSR1        (PUBL_REG_BASE+0x82*4) 
#define PUBL_DX1DLLCR       (PUBL_REG_BASE+0x83*4) 
#define PUBL_DX1DQTR        (PUBL_REG_BASE+0x84*4) 
#define PUBL_DX1DQSTR       (PUBL_REG_BASE+0x85*4) 
#define PUBL_DX2GCR         (PUBL_REG_BASE+0x90*4) 
#define PUBL_DX2GSR0        (PUBL_REG_BASE+0x91*4) 
#define PUBL_DX2GSR1        (PUBL_REG_BASE+0x92*4) 
#define PUBL_DX2DLLCR       (PUBL_REG_BASE+0x93*4) 
#define PUBL_DX2DQTR        (PUBL_REG_BASE+0x94*4) 
#define PUBL_DX2DQSTR       (PUBL_REG_BASE+0x95*4) 
#define PUBL_DX3GCR         (PUBL_REG_BASE+0xA0*4) 
#define PUBL_DX3GSR0        (PUBL_REG_BASE+0xA1*4) 
#define PUBL_DX3GSR1        (PUBL_REG_BASE+0xA2*4) 
#define PUBL_DX3DLLCR       (PUBL_REG_BASE+0xA3*4) 
#define PUBL_DX3DQTR        (PUBL_REG_BASE+0xA4*4) 
#define PUBL_DX3DQSTR       (PUBL_REG_BASE+0xA5*4) 
#define PUBL_DX4GCR         (PUBL_REG_BASE+0xB0*4) 
#define PUBL_DX4GSR0        (PUBL_REG_BASE+0xB1*4) 
#define PUBL_DX4GSR1        (PUBL_REG_BASE+0xB2*4) 
#define PUBL_DX4DLLCR       (PUBL_REG_BASE+0xB3*4) 
#define PUBL_DX4DQTR        (PUBL_REG_BASE+0xB4*4) 
#define PUBL_DX4DQSTR       (PUBL_REG_BASE+0xB5*4) 
#define PUBL_DX5GCR         (PUBL_REG_BASE+0xC0*4) 
#define PUBL_DX5GSR0        (PUBL_REG_BASE+0xC1*4) 
#define PUBL_DX5GSR1        (PUBL_REG_BASE+0xC2*4) 
#define PUBL_DX5DLLCR       (PUBL_REG_BASE+0xC3*4) 
#define PUBL_DX5DQTR        (PUBL_REG_BASE+0xC4*4) 
#define PUBL_DX5DQSTR       (PUBL_REG_BASE+0xC5*4) 
#define PUBL_DX6GCR         (PUBL_REG_BASE+0xD0*4) 
#define PUBL_DX6GSR0        (PUBL_REG_BASE+0xD1*4) 
#define PUBL_DX6GSR1        (PUBL_REG_BASE+0xD2*4) 
#define PUBL_DX6DLLCR       (PUBL_REG_BASE+0xD3*4) 
#define PUBL_DX6DQTR        (PUBL_REG_BASE+0xD4*4) 
#define PUBL_DX6DQSTR       (PUBL_REG_BASE+0xD5*4) 
#define PUBL_DX7GCR         (PUBL_REG_BASE+0xE0*4) 
#define PUBL_DX7GSR0        (PUBL_REG_BASE+0xE1*4) 
#define PUBL_DX7GSR1        (PUBL_REG_BASE+0xE2*4) 
#define PUBL_DX7DLLCR       (PUBL_REG_BASE+0xE3*4) 
#define PUBL_DX7DQTR        (PUBL_REG_BASE+0xE4*4) 
#define PUBL_DX7DQSTR       (PUBL_REG_BASE+0xE5*4) 
#define PUBL_DX8GCR         (PUBL_REG_BASE+0xF0*4) 
#define PUBL_DX8GSR0        (PUBL_REG_BASE+0xF1*4) 
#define PUBL_DX8GSR1        (PUBL_REG_BASE+0xF2*4) 
#define PUBL_DX8DLLCR       (PUBL_REG_BASE+0xF3*4) 
#define PUBL_DX8DQTR        (PUBL_REG_BASE+0xF4*4) 
#define PUBL_DX8DQSTR       (PUBL_REG_BASE+0xF5*4) 
...
void main_entry(void)
{
	...
	REG32(0x40060044) |= (1 << 0);
	for(i = 0; i < 20; i++);
	REG32(0x40060040) |= (3 <<5);
