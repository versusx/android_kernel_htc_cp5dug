...
#define REG_AON_APB_MPLL_CFG            SCI_ADDR(REGS_AON_APB_BASE, 0x0014)
#define REG_AON_APB_DPLL_CFG            SCI_ADDR(REGS_AON_APB_BASE, 0x0018)
#define REG_AON_APB_TDPLL_CFG           SCI_ADDR(REGS_AON_APB_BASE, 0x001C)
#define REG_AON_APB_CPLL_CFG            SCI_ADDR(REGS_AON_APB_BASE, 0x0020)
#define REG_AON_APB_WIFIPLL0_CFG        SCI_ADDR(REGS_AON_APB_BASE, 0x0024)
#define REG_AON_APB_WIFIPLL1_CFG        SCI_ADDR(REGS_AON_APB_BASE, 0x0028)
#define REG_AON_APB_WPLL_CFG0           SCI_ADDR(REGS_AON_APB_BASE, 0x002C)
#define REG_AON_APB_WPLL_CFG1           SCI_ADDR(REGS_AON_APB_BASE, 0x0030)
#define REG_AON_APB_AON_CGM_CFG         SCI_ADDR(REGS_AON_APB_BASE, 0x0034)
#define REG_AON_APB_REC_26MHZ_BUF_CFG   SCI_ADDR(REGS_AON_APB_BASE, 0x0050)
#define REG_AON_APB_SINDRV_CTRL         SCI_ADDR(REGS_AON_APB_BASE, 0x0054)
#define REG_AON_APB_ADA_SEL_CTRL        SCI_ADDR(REGS_AON_APB_BASE, 0x0058)
#define REG_AON_APB_VBC_CTRL            SCI_ADDR(REGS_AON_APB_BASE, 0x005C)
#define REG_AON_APB_PWR_CTRL            SCI_ADDR(REGS_AON_APB_BASE, 0x0060)
#define REG_AON_APB_CP0_ADDR_REMAP_CTRL0 SCI_ADDR(REGS_AON_APB_BASE, 0x0064)
#define REG_AON_APB_CP0_ADDR_REMAP_CTRL1 SCI_ADDR(REGS_AON_APB_BASE, 0x0068)
#define REG_AON_APB_CP1_ADDR_REMAP_CTRL0 SCI_ADDR(REGS_AON_APB_BASE, 0x006C)
#define REG_AON_APB_CP1_ADDR_REMAP_CTRL1 SCI_ADDR(REGS_AON_APB_BASE, 0x0070)
#define REG_AON_APB_CP2_ADDR_REMAP_CTRL0 SCI_ADDR(REGS_AON_APB_BASE, 0x0074)
#define REG_AON_APB_CP2_ADDR_REMAP_CTRL1 SCI_ADDR(REGS_AON_APB_BASE, 0x0078)
#define REG_AON_APB_AP_WPROT_EN         SCI_ADDR(REGS_AON_APB_BASE, 0x007C)
#define REG_AON_APB_CP0_WPROT_EN        SCI_ADDR(REGS_AON_APB_BASE, 0x0080)
#define REG_AON_APB_CP1_WPROT_EN        SCI_ADDR(REGS_AON_APB_BASE, 0x0084)
#define REG_AON_APB_CP2_WPROT_EN        SCI_ADDR(REGS_AON_APB_BASE, 0x0088)
#define REG_AON_APB_TS_CFG              SCI_ADDR(REGS_AON_APB_BASE, 0x008C)
#define REG_AON_APB_BOOT_MODE           SCI_ADDR(REGS_AON_APB_BASE, 0x0090)
#define REG_AON_APB_BB_BG_CTRL          SCI_ADDR(REGS_AON_APB_BASE, 0x0094)
#define REG_AON_APB_IO_DLY_CTRL         SCI_ADDR(REGS_AON_APB_BASE, 0x0098)
#define REG_AON_APB_CP_ARM_JTAG_CTRL    SCI_ADDR(REGS_AON_APB_BASE, 0x009C)
#define REG_AON_APB_PLL_SOFT_CNT_DONE   SCI_ADDR(REGS_AON_APB_BASE, 0x00A0)
#define REG_AON_APB_PMU_RST_MONITOR     SCI_ADDR(REGS_AON_APB_BASE, 0x00A4)
#define REG_AON_APB_THM_RST_MONITOR     SCI_ADDR(REGS_AON_APB_BASE, 0x00A8)
#define REG_AON_APB_AP_RST_MONITOR      SCI_ADDR(REGS_AON_APB_BASE, 0x00AC)
...
#define REG_AON_APB_RES_REG0            SCI_ADDR(REGS_AON_APB_BASE, 0x00BC)
#define REG_AON_APB_RES_REG1            SCI_ADDR(REGS_AON_APB_BASE, 0x00C0)
