 ...
 * NOTE: VA should not locate in lowmem address space
 *
 */
...
#define SPRD_ADISLAVE_BASE		SCI_IOMAP(0x3f8000)  //SPRD release codebase is 0x3f0000 + SZ_32K, it will cause build break. Corrtect it to 0x3f8000
...
#define SIPC_SMEM_ADDR		0x87C00000

#define CPT_SMEM_SIZE		(SZ_1M * 2)

#define CPT_START_ADDR		0x87E00000
#define CPT_TOTAL_SIZE		(SZ_1M * 24)

#define CPT_RING_ADDR		(CPT_START_ADDR + SZ_1M - SZ_4K)
#define CPT_RING_SIZE		(SZ_4K)
#define CPT_MODEM_ADDR		(CPT_START_ADDR + SZ_1M * 7)
#define CPT_DSP_ADDR		(CPT_START_ADDR + SZ_1M * 2 + 0x20000)
#define CPT_NVD_ADDR		(CPT_START_ADDR + SZ_1M * 1 + SZ_128K * 2)
#define CPT_NVC_ADDR		(CPT_START_ADDR + SZ_1M * 1 + SZ_128K * 5)
#define CPT_NVP_ADDR		(CPT_START_ADDR + SZ_1M * 5 + SZ_128K * 2)
#define CPT_NVF_ADDR		(CPT_START_ADDR + SZ_1M * 5 + SZ_128K * 5)
#define CPT_NVR_ADDR		(CPT_START_ADDR + SZ_1M * 5 + SZ_128K * 8)
#define CPT_C_CMDLINE_ADDR	(CPT_START_ADDR + SZ_1M - SZ_4K - SZ_1K)
#define CPT_N_CMDLINE_ADDR	(CPT_START_ADDR + SZ_1M - SZ_4K - SZ_2K)
#define CPT_MODEM_SIZE		(SZ_1M * 7)
#define CPT_DSP_SIZE		(SZ_1M * 3 - 0x20000)
#define CPT_NVD_SIZE		(SZ_128K * 3)
#define CPT_NVC_SIZE		(SZ_128K * 3)
#define CPT_NVF_SIZE		(SZ_128K * 3)
#define CPT_NVP_SIZE		(SZ_128K * 3)
#define CPT_NVR_SIZE		(SZ_128K * 6)
#define CPT_C_CMDLINE_SIZE	(SZ_1K)
#define CPT_N_CMDLINE_SIZE	(SZ_1K)
#else /* !CONFIG_MACH_Z4TD */
#define SIPC_SMEM_ADDR		0x87A00000
...
#define CPT_RING_ADDR		(CPT_START_ADDR + SZ_1M - SZ_8K)
#define CPT_RING_SIZE		(SZ_8K)
#define CPT_MODEM_ADDR		(CPT_START_ADDR + SZ_1M * 7)
#define CPT_DSP_ADDR		(CPT_START_ADDR + SZ_1M * 2 + 0x20000)
#define CPT_NVD_ADDR		(CPT_START_ADDR + SZ_1M * 1 + SZ_128K * 2)
#define CPT_NVC_ADDR		(CPT_START_ADDR + SZ_1M * 1 + SZ_128K * 5)
...
#define CPT_NVF_ADDR		(CPT_START_ADDR + SZ_1M * 5 + SZ_128K * 5)
#define CPT_NVR_ADDR		(CPT_START_ADDR + SZ_1M * 5 + SZ_128K * 8)
#define CPT_C_CMDLINE_ADDR	(CPT_START_ADDR + SZ_1M - SZ_8K - SZ_1K)
#define CPT_N_CMDLINE_ADDR	(CPT_START_ADDR + SZ_1M - SZ_8K - SZ_2K)
#define CPT_MODEM_SIZE		(SZ_1M * 7)
#define CPT_DSP_SIZE		(SZ_1M * 3 - 0x20000)
#define CPT_NVD_SIZE		(SZ_128K * 3)
#define CPT_NVC_SIZE		(SZ_128K * 3)
...
#define CPW_START_ADDR		(0x8FE00000)
#define CPW_TOTAL_SIZE		(SZ_1M * 46)

#define CPW_RING_ADDR		(CPW_START_ADDR + SZ_1M - SZ_8K)
#define CPW_RING_SIZE		(SZ_8K)
#define CPW_C_CMDLINE_ADDR	(CPW_START_ADDR + SZ_1M - SZ_8K - SZ_1K)
#define CPW_C_CMDLINE_SIZE	(SZ_1K)
#define CPW_N_CMDLINE_ADDR	(CPW_START_ADDR + SZ_1M - SZ_8K - SZ_2K)
#define CPW_N_CMDLINE_SIZE	(SZ_1K)
#define CPW_NVD_ADDR		(CPW_START_ADDR + 0x00140000)
#define CPW_NVD_SIZE		(SZ_128K * 3)
#define CPW_NVC_ADDR		(CPW_START_ADDR + 0x001A0000)
#define CPW_NVC_SIZE		(SZ_128K * 3)
#define CPW_DSP_ADDR		(CPW_START_ADDR + 0x00220000)
#define CPW_DSP_SIZE		(0x002E0000)
#define CPW_NVP_ADDR		(CPW_START_ADDR + 0x00540000)
#define CPW_NVP_SIZE		(SZ_128K * 3)
#define CPW_NVF_ADDR		(CPW_START_ADDR + 0x005A0000)
#define CPW_NVF_SIZE		(SZ_128K * 3)
#define CPW_NVR_ADDR		(CPW_START_ADDR + 0x00600000)
#define CPW_NVR_SIZE		(SZ_128K * 6)
#define CPW_MODEM_ADDR		(CPW_START_ADDR + 0x00700000)
#define CPW_MODEM_SIZE		(SZ_1M * 9)
#endif /* End of CONFIG_MACH_Z4TD */

#define WCN_START_ADDR         (CONFIG_PHYS_OFFSET + 320 * SZ_1M)
#define WCN_TOTAL_SIZE         (SZ_1M * 16)
