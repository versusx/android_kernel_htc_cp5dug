...
{                                                                                                                                      
    ...
    {                                                                                                                                  
        ...
        {                                                                                                                              
            instance->log_error("[DISP] invalid colour configuration");
        }                                                                                                                              
...
{                                                                                                                                      
    ...
    {                                                                                                                                  
        if (instance->log_error != 0)                                                                                                  
        {                                                                                                                              
            instance->log_error("[DISP] undefined type");
        }                                                                                                                              
...
{                                                                                                                                      
    ...
    {                                                                                                                                  
        ...
        default:                                                                                                                       
            if (instance->log_error != 0)                                                                                              
            {                                                                                                                          
                instance->log_error("[DISP] undefined DCS Read packet type");
            }                                                                                                                          
...
{                                                                                                                                      
    ...
    {                                                                                                                                  
        ...
        default:                                                                                                                       
            if (instance->log_error != 0)                                                                                              
            {                                                                                                                          
                instance->log_error("[DISP] undefined Generic Read packet type");
            }                                                                                                                          
            err = ERR_DSI_OUT_OF_BOUND;                                                                                                
            break;                                                                                                                     
    }                                                                                                                                  
