...
typedef struct sensor_gpio_ctrl 
{
    uint32_t pin_num;
    uint32_t value;
}SENSOR_GPIO_CTRL_T;
...
#define MISC_BASE SPRD_MISC_BASE	
...
#define SENSOR_IO_I2C_READ_EXT     _IOW(SENSOR_IOC_MAGIC, 19,  SENSOR_I2C_T)
#define SENSOR_IO_SET_RESET_L2H          _IOW(SENSOR_IOC_MAGIC, 20,  uint32_t)
#define SENSOR_IO_SET_RESET_L2H2L          _IOW(SENSOR_IOC_MAGIC, 21,  uint32_t)
#define SENSOR_IO_SET_GPIO                      _IOW(SENSOR_IOC_MAGIC, 22,  SENSOR_GPIO_CTRL_T)
